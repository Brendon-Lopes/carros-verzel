...
public class Seeder
{
    ...
    public void Execute()
    {
        ...
        _context.Cars.AddRange(new[]{
            ...
            new Car { BrandId = chevroletBrand.BrandId, Name = "Chevrolet Celta 2010", Model = "Celta", Year = 2010, Price = 18000, ImageUrl = "https://www.carrosnaweb.com.br/imagensbd007/celta-life-2p-2009-1.jpg" },
            ...
            new Car { BrandId = lamborghiniBrand.BrandId, Name = "Lamborghini Aventador 2022", Model = "Aventador", Year = 2022, Price = 4500000, ImageUrl = "https://www.carrosnaweb.com.br/imagensbd007/Aventador-SVJ-2019-1.jpg" },
        });
